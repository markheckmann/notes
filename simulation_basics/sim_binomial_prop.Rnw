...
Gemäß der Formel beläuft sich das Konfidenzintervall somit auf $0.05 \pm \Sexpr{round(ci_standard(p.hat=.05, n=500), 3)}$. 
...
<<echo=F>>=
x <- read.csv2("data/p_study_wilson_pstep_001_n10_100_reps_10000.csv")
@
